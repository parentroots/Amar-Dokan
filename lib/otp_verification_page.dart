             ...
             Padding(
               ...
               child: SizedBox(
                 height: 70,
                   width: 70,
                   child:   CircleAvatar(
                     backgroundImage: NetworkImage("https://www.shutterstock.com/shutterstock/photos/1033217617/display_1500/stock-vector-green-check-mark-icon-in-a-circle-check-list-button-icon-1033217617.jpg"),
                   ),),

             ),
              Text("Password Change !",style: TextStyle(
                fontSize: 22,
                color: Colors.black,
              ...
              Padding(
                ...
                child: Align(
                  ...
                  child: Text("Password change Please LOGIN again",style: TextStyle(
                      fontSize: 16,
                      color: Colors.black,
              ...
              Padding(
                ...
                child: SizedBox(
                  width: 200,
                    ...
                    }, child: Text("GO LOGIN",style: TextStyle(
                      fontSize: 20,
                      color: Colors.white
                    ),))),
              )
