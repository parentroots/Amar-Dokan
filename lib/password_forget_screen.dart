...
class _PasswordForgetScreenState extends State<PasswordForgetScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Password Forgot",style: TextStyle(
          color: Colors.white
        ),),
      ),
                ...
                child: Form(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text("If you reset Password need email verification,click reset password and check your email and submit 6 digit code"),
                    ),
                      ...
                      child: SizedBox(
                        ...
                        child: ElevatedButton(onPressed: (){
                          ...
                          if(_formKey.currentState!.validate()){
                            ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Account found Please Wait")));
